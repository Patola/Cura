...
class ExtruderManager(QObject):
    ...
    globalContainerStackDefinition = pyqtSignal()
    ...
    def __init__(self, parent = None):
        ...
        self._global_container_stack_definition = None
    ...
    def __globalContainerStackChanged(self):
        self._addCurrentMachineExtruders()
        global_container_stack = UM.Application.getInstance().getGlobalContainerStack()
        if global_container_stack and global_container_stack.getBottom() and global_container_stack.getBottom().getId() != self._global_container_stack_definition:
            self._global_container_stack_definition = global_container_stack.getBottom().getId()
            self.globalContainerStackDefinition.emit()
        self.activeExtruderChanged.emit()
